        ...
        AddNewSTD(
            {
                variables: {
                    ...
                    cnic: parseInt(cnicInput.current.value),
                    ...
                    fatherCNIC: parseInt(fathercnicInput.current.value),
                    MotherCNIC: parseInt(mothercnicInput.current.value),
                    phoneNumber: parseInt(phonenumberInput.current.value),
